    ...
    <>
      ...
      <Section variant="primary">
        <div className="max-w-4xl mx-auto">
          <AnimatedSection>
            <div className="relative bg-gradient-to-br from-emerald-500 via-teal-600 to-emerald-700 rounded-3xl p-12 md:p-16 shadow-xl shadow-emerald-700/20 overflow-hidden">
              ...
              <div className="relative z-10 text-center">
                ...
                <h2 className="text-3xl md:text-4xl font-serif font-semibold text-emerald-50 mb-4 tracking-tight leading-tight">
                  {category.purchaseCTA || 'מוכן להתחיל את המסע?'}
                </h2>
                <p className="text-base md:text-lg text-emerald-50/90 mb-10 font-normal max-w-2xl mx-auto">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                  ...
                  <Link
                    to="/booking"
                    className="inline-flex items-center justify-center px-8 py-4 rounded-xl bg-emerald-900 text-white border border-emerald-900 hover:bg-emerald-950 transition-all duration-300 shadow-md hover:shadow-lg font-semibold"
                  >
                    קבע פגישה
                  </Link>
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center justify-center px-8 py-4 rounded-xl bg-green-600 text-white border border-green-700 hover:bg-green-700 transition-all duration-300 shadow-md hover:shadow-lg font-semibold"
                  >
