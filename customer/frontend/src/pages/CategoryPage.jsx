              ...
              <div className="relative z-10 text-center">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                  <Button 
                    ...
                    variant="primary"
                    className="bg-white text-primary-700 border border-white hover:bg-neutral-50 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 px-8 py-4 text-lg font-semibold"
                  >
                    רכוש מסלול
                  </Button>
                  <Button 
                    to="/booking" 
                    variant="primary"
                    className="bg-primary-900 text-white border border-primary-900 hover:bg-primary-950 hover:border-primary-950 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 px-8 py-4 text-lg font-semibold"
                  >
                    קבע פגישה
                  </Button>
                  <Button
                    ...
                    variant="secondary"
                    target="_blank"
                    className="bg-emerald-600 border border-emerald-700 hover:bg-emerald-700 hover:border-emerald-800 text-white shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 px-8 py-4 text-lg font-semibold"
                  >
