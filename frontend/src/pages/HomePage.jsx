...
function HomePage() {
  ...
  return (
    <>
      ...
      {/* המלצות Section */}
      <Section variant="neutral" id="testimonials">
        <AnimatedSection>
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-serif font-bold text-neutral-900 mb-4">
              מה אומרים
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {[
            {
              name: 'שרה',
              text: 'התהליך עזר לי להבין את החרדות שלי ולמצוא כלים מעשיים להתמודד איתן. אני מרגישה הרבה יותר שלווה ונוכחת בחיים שלי.',
            },
            {
              name: 'דוד',
              text: 'אחרי שנים של התמודדות עם טראומה מהצבא, סוף סוף מצאתי מקום שבו יכולתי באמת לעבד את מה שעברתי. זה שינה לי את החיים.',
            },
            {
              name: 'מיכל',
              text: 'הגעתי מתוך תחושה של תקיעות. התהליך עזר לי לזהות דפוסים שמחזיקים אותי, ולשחרר אותם. עכשיו אני מרגישה שאני חיה את החיים שלי באמת.',
            },
